...
RUNNING_ENV = getenv("RUNNING_ENV", "local").lower()

# Path to the separated env files
django_env = path.join(BASE_DIR, ".envs", f".{RUNNING_ENV}", ".django")
postgres_env = path.join(BASE_DIR, ".envs", f".{RUNNING_ENV}", ".postgres")
